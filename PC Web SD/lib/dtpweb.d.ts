 ...
 * @brief PC JavaScript 版本 LPAPI 接口的异步封装，底层基于 dtpweb 打印接口。
 * @version 2.1
 * @date 2022-06-27
 *
 ...
 *
 */
import { LPA_JobPrintOptions, LPA_JobPreviewOptions, LPA_FontStyle, LPA_GapType, LPA_ItemAlignment, LPA_JobNames, LPA_PageImage, LPA_PageInfo, LPA_ParamID, LPA_PrintDarkness, LPA_PrintSpeed, LPA_PrinterPropertyOptions, LPA_PrinterOptions, LPA_Device, LPA_PrintParamOptions, LPA_JobInfo, LPA_PageImageOptions, PrintOptions, DrawTextOptions, DrawBarcodeOptions, DrawQrcodeOptions, DrawPdf417Options, DrawRectOptions, FillRectOptions, DrawLineOptions, DrawImageUrlOptions, DrawImageDataOptions, PrintImageOptions, RawDataPrintOptions, PackagePrintOptions, DrawCircleOptions, FillCircleOptions, LPA_DrawResultOptions, LPA_InitOptions, PrintJobOptions, PrintJobResults, DrawDataMatrixOptions, LPA_PrintActions } from './utils';
/**
 * 接口初始信息配置选项。
 */
interface InitOptions extends LPA_InitOptions {
    callback?: (api?: DTPWeb) => void;
}
/**
...
declare class DTPWeb {
     ...
     */
    static getApi(options?: InitOptions): DTPWeb;
    /**
     * 获取一个单实例接口对象。
     *
     ...
     * @returns 返回一个单实例接口对象。
     */
    static getInstance(options?: InitOptions): DTPWeb;
    /** 初始化IP地址 */
    private _initIp?;
    /** 初始化端口号 */
    private _initPort?;
    ...
    protected parseMargin(options: LPA_JobPrintOptions): number[];
     ...
     *
     * @returns {Promise<DTPWeb|undefined>} 插件是否可用？udefined表示插件不可用。
     */
    checkPlugin(callback?: (api?: DTPWeb) => void): Promise<DTPWeb | undefined>;
    /**
     * 检查指定的端口号是否可用。
     *
     ...
     *
     * @return {Promise<DTPWeb|undefined>} 端口是否可用，undefined表示端口不可用，否则可用。
     */
    checkPort(port?: number, callback?: (api?: DTPWeb) => void): Promise<DTPWeb | undefined>;
    /**
     * 请求web服务器。
     *
     ...
     */
    setItemOrientation(orientation: number): Promise<boolean>;
    /**
     * 获取当前操作的水平对齐方式。
     */
    getItemHorizontalAlignment(): Promise<LPA_ItemAlignment>;
    /**
     * 设置后续操作的水平对齐方式。
     *
     ...
     */
    setItemHorizontalAlignment(alignment: number): Promise<boolean>;
    /**
     * 获取当前操作的垂直对齐方式。
     */
    getItemVerticalAlignment(): Promise<LPA_ItemAlignment>;
    /**
     * 设置后续操作的垂直对齐方式。
     *
     ...
     */
    setItemVerticalAlignment(alignment: LPA_ItemAlignment): Promise<boolean>;
    /**
     * 搜索局域网内的打印机。
     *
     ...
     * @returns 成功与否。
     */
    discoveryPrinters(mode?: number): Promise<boolean>;
    /**
     * 获取打印机列表。
     *
     ...
     *
     * @return {Promise<LPA_Device[]>} 返回打印机设备列表。
     */
     ...
     * 判断当前打印机是否在线。
     */
    isPrinterOnline(): Promise<boolean>;
    /**
     * 关闭已经打开的打印机。
     *
     ...
     */
    showProperty(data: LPA_PrinterPropertyOptions): Promise<boolean>;
    /**
     * 获取打印相关参数。
     *
     * @param {LPA_ParamID} id 打印参数ID，ID值可参考 {@link LPA_ParamID}。
     *
     * @return {Promise<number>} 值参考 {@link LPA_ParamID} 中不同ID所对应的值类型。
     */
     ...
     */
    startJob(options: LPA_JobPrintOptions): Promise<boolean>;
    /**
     * 创建预览任务。
     *
     * @param {LPA_JobPrintOptions} options 标签任务选项。
     ...
     */
    startPreview(options: LPA_JobPreviewOptions): Promise<boolean>;
    /**
     *  取消当前打印任务。
     *
     ...
     */
    getJobInfo(options: LPA_JobInfo): Promise<any>;
    /**
     * 得到刚完成的打印任务的打印任务信息。
     *
     ...
     */
    returnDrawResult(options: LPA_DrawResultOptions | boolean): Promise<boolean>;
    /*********************************************************************
     * 绘制相关内容。
     *********************************************************************/
    /**
     ...
     * @returns 成功与否。
     */
    draw2DDataMatrix(options: DrawDataMatrixOptions): Promise<boolean>;
    /**
     * 绘制矩形框。
     *
     ...
     *          不指定表示使用 {@link setItemOrientation()} 设置的参数。默认为0，表示不旋转。
     */
    fillRectangle(options: FillRectOptions): Promise<boolean>;
    /**
     * 绘制圆角矩形。
     *
     ...
     *          不指定表示使用 {@link setItemOrientation()} 设置的参数。默认为0，表示不旋转。
     */
    drawRoundRectangle(options: DrawRectOptions): Promise<boolean>;
    /**
     * 绘制填充圆角矩形。
     *
     ...
     *          不指定表示使用 {@link setItemOrientation()} 设置的参数。默认为0，表示不旋转。
     */
    fillRoundRectangle(options: FillRectOptions): Promise<boolean>;
    /**
     * 绘制椭圆边框。
     *
     ...
     *          不指定表示使用 {@link setItemOrientation()} 设置的参数。默认为0，表示不旋转。
     */
    fillEllipse(options: FillRectOptions): Promise<boolean>;
    /**
     * 绘制圆形。
     *
     ...
     * @param {number|undefined} options.radius 圆形半径，单位毫米，值默认为{@link CONSTANTS.RADIUS}。
     */
    fillCircle(options: FillCircleOptions): Promise<boolean>;
    /**
     * 绘制直线。
     *
     ...
     */
    drawDashLine(options: DrawLineOptions): Promise<boolean>;
    /**
     *  打印指定的URL图片。
     *
     ...
     * @param {string|undefined} options.jobName 打印任务名称。
     */
    printRawData(options: RawDataPrintOptions): Promise<boolean>;
    /**
     ...
     * @param {string|undefined} options.jobName 打印任务名称。
     */
    printPackage(options: PackagePrintOptions): Promise<boolean>;
    /**
     ...
     * @returns 打印成功与否
     */
    print(options: PrintJobOptions): Promise<PrintJobResults | undefined>;
}
export { DTPWeb, LPA_ParamID, LPA_GapType, LPA_PrintSpeed, LPA_PrintDarkness, LPA_ItemAlignment, LPA_FontStyle, LPA_JobNames, LPA_PrintActions, DrawImageDataOptions, PrintImageOptions, };
