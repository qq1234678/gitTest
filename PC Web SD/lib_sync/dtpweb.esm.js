...
var utils = {
    ...
    getTimeout: function (timeout, type) {
...
var DTPWeb = /** @class */ (function () {
    ...
    DTPWeb.prototype.requestApi = function (options, data) {
        ...
        utils.request({
            ...
            console.log("## onResponse: ".concat(config.action, " ##"));
            console.log(result);
            resolve = result;
        });
        return resolve;
    ...
    DTPWeb.prototype.setItemOrientation = function (orientation) {
        ...
        var resp = this.requestApi(ACTIONS.SetItemOrientation, data);
    ...
    DTPWeb.prototype.setItemHorizontalAlignment = function (alignment) {
        ...
        var resp = this.requestApi(ACTIONS.SetItemHorizontalAlignment, data);
        return (resp === null || resp === void 0 ? void 0 : resp.statusCode) === LPA_Result.OK;
    };
    /**
     * 获取当前操作的垂直对齐方式。
    ...
    DTPWeb.prototype.setItemVerticalAlignment = function (alignment) {
        var data = utils.getRequestData(['alignment'], [alignment]);
        var resp = this.requestApi(ACTIONS.SetItemVerticalAlignment, data);
        return (resp === null || resp === void 0 ? void 0 : resp.statusCode) === LPA_Result.OK;
    };
    /**
     * 搜索局域网内的打印机。
    ...
    DTPWeb.prototype.getPrinterDPI = function () {
        return this.getParam(LPA_ParamID.PrinterDPI);
    };
    /**
     * 创建打印任务。
     *
    ...
    DTPWeb.prototype.startPreview = function (options) {
        ...
        //
        var resp = this.requestApi(ACTIONS.StartPreview, options);
        return (resp === null || resp === void 0 ? void 0 : resp.statusCode) === LPA_Result.OK;
    };
    /**
     *  取消当前打印任务。
    ...
    DTPWeb.prototype.fillRectangle = function (options) {
        ...
        //
        var resp = this.requestApi(ACTIONS.FillRectangle, options);
        return (resp === null || resp === void 0 ? void 0 : resp.statusCode) === LPA_Result.OK;
    };
    /**
     * 绘制圆角矩形。
    ...
    DTPWeb.prototype.fillRoundRectangle = function (options) {
        ...
        options = utils.unitConvertOfFillRect(options, this._margins);
        //
        var resp = this.requestApi(ACTIONS.FillRoundRectangle, options);
        return (resp === null || resp === void 0 ? void 0 : resp.statusCode) === LPA_Result.OK;
    };
    /**
     * 绘制椭圆边框。
    ...
    DTPWeb.prototype.fillEllipse = function (options) {
        ...
        options = utils.unitConvertOfFillRect(options, this._margins);
        //
        var resp = this.requestApi(ACTIONS.FillEllipse, options);
        return (resp === null || resp === void 0 ? void 0 : resp.statusCode) === LPA_Result.OK;
    };
    /**
     * 绘制圆形。
    ...
    DTPWeb.prototype.printImage = function (options) {
        var _a;
        options = utils.getRequestData(['data', 'printerName'], arguments);
        if (!options.data)
            return false;
        //
        options.scaleUnit = 1;
    ...
    DTPWeb.prototype.printRawData = function (options) {
        ...
        if (!options.data)
            return false;
        //
        var resp = this.requestApi(ACTIONS.PrintRawData, options);
        return resp ? resp.statusCode === LPA_Result.OK : false;
    };
    /**
    ...
    DTPWeb.prototype.printPackage = function (options) {
        ...
        if (!options.data)
            return false;
        //
        var resp = this.requestApi(ACTIONS.PrintPackage, options);
        return resp ? resp.statusCode === LPA_Result.OK : false;
    };
    /**
...
export { DTPWeb, LPA_FontStyle, LPA_GapType, LPA_ItemAlignment, LPA_JobNames, LPA_ParamID, LPA_PrintActions, LPA_PrintDarkness, LPA_PrintSpeed };
