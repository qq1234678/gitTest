...
declare class DTPWeb {
     ...
     */
    checkPlugin(callback?: (api?: DTPWeb) => void): void;
    /**
     * 检查指定的端口号是否可用。
     *
     ...
     */
    checkPort(port?: number, callback?: (api?: DTPWeb) => void): void;
    /**
     * 请求web服务器。
     *
     ...
     */
    setItemOrientation(orientation: number): boolean;
    /**
     * 获取当前操作的水平对齐方式。
     */
    getItemHorizontalAlignment(): LPA_ItemAlignment;
    /**
     * 设置后续操作的水平对齐方式。
     *
     ...
     */
    setItemHorizontalAlignment(alignment: number): boolean;
    /**
     * 获取当前操作的垂直对齐方式。
     */
    getItemVerticalAlignment(): LPA_ItemAlignment;
    /**
     * 设置后续操作的垂直对齐方式。
     *
     ...
     */
    setItemVerticalAlignment(alignment: LPA_ItemAlignment): boolean;
    /**
     * 搜索局域网内的打印机。
     *
     ...
     */
    getPrinters(options: LPA_PrinterOptions): LPA_Device[];
    /**
     * 打开指定的打印机。
     *
     ...
     */
    openPrinter(printer?: string | LPA_Device | undefined): boolean;
    /**
     * 获取已连接的打印机名称。
     */
     ...
     */
    startJob(options: LPA_JobPrintOptions): boolean;
    /**
     * 创建预览任务。
     *
     ...
     */
    startPreview(options: LPA_JobPreviewOptions): boolean;
    /**
     *  取消当前打印任务。
     *
     ...
     */
    commitJob(options?: PrintOptions): boolean;
    /**
     * 得到最近一次打印任务的标识。
     *
     * @return 打印任务标识。
     ...
     */
    getJobInfo(options: LPA_JobInfo): any;
    /**
     * 得到刚完成的打印任务的打印任务信息。
     *
     ...
     *          不指定表示使用 {@link setItemOrientation()} 设置的参数。默认为0，表示不旋转。
     */
    fillRectangle(options: FillRectOptions): boolean;
    /**
     * 绘制圆角矩形。
     *
     ...
     *          不指定表示使用 {@link setItemOrientation()} 设置的参数。默认为0，表示不旋转。
     */
    fillRoundRectangle(options: FillRectOptions): boolean;
    /**
     * 绘制椭圆边框。
     *
     ...
     *          不指定表示使用 {@link setItemOrientation()} 设置的参数。默认为0，表示不旋转。
     */
    fillEllipse(options: FillRectOptions): boolean;
    /**
     * 绘制圆形。
     *
     ...
     * @param {number|undefined} options.radius 圆形半径，单位毫米，值默认为{@link CONSTANTS.RADIUS}。
     */
    fillCircle(options: FillCircleOptions): boolean;
    /**
     * 绘制直线。
     *
     ...
     * @returns 打印成功与否
     */
    print(options: PrintJobOptions): PrintJobResults | undefined;
}
